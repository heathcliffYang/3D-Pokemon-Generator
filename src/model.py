...
class net_G(torch.nn.Module):
    def __init__(self, args):
        ...
        self.layer0 = self.conv_layer(self.z_dim, self.f_dim*16, kernel_size=4, stride=2, padding=padd, bias=self.bias)
        self.layer1 = self.conv_layer(self.f_dim*16, self.f_dim*8, kernel_size=4, stride=2, padding=(1, 1, 1), bias=self.bias)
